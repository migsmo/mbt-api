...
let DeleteCustomerService = class DeleteCustomerService {
    supabase;
    ...
    async deleteCustomer(id) {
        const { error } = await this.supabase
            ...
            .eq('id', id);
        if (error) {
            throw new base_error_1.BaseError(`Failed to delete customer: ${error.message}`);
        }
        const response = {
            customerId: id,
            deleteSuccess: true,
...
exports.DeleteCustomerService = DeleteCustomerService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(supabase_request_provider_1.SUPABASE_REQUEST_CLIENT)),
    __metadata("design:paramtypes", [supabase_js_1.SupabaseClient])
], DeleteCustomerService);
//# sourceMappingURL=delete-customer.service.js.map