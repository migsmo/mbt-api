...
let UpdateAppointmentStatusService = class UpdateAppointmentStatusService {
    supabase;
    ...
    async updateAppointmentStatus(request) {
        ...
        if (appointment.error) {
            throw new base_error_1.BaseError(`Failed to update appointment status: ${appointment.error.message}`);
        }
        const response = {
...
exports.UpdateAppointmentStatusService = UpdateAppointmentStatusService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(supabase_request_provider_1.SUPABASE_REQUEST_CLIENT)),
    __metadata("design:paramtypes", [supabase_js_1.SupabaseClient])
], UpdateAppointmentStatusService);
//# sourceMappingURL=update-appointment-status.service.js.map