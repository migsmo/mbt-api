...
let DeleteEmployeeService = class DeleteEmployeeService {
    supabase;
    ...
    async deleteEmployee(id) {
        const { error } = await this.supabase
            ...
            .eq('id', id);
        if (error) {
            throw new base_error_1.BaseError(`Failed to delete employee: ${error.message}`);
        }
        const response = {
            employeeId: id,
            deleteSuccess: true,
...
exports.DeleteEmployeeService = DeleteEmployeeService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(supabase_request_provider_1.SUPABASE_REQUEST_CLIENT)),
    __metadata("design:paramtypes", [supabase_js_1.SupabaseClient])
], DeleteEmployeeService);
//# sourceMappingURL=delete-employee.service.js.map